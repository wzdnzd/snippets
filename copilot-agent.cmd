...
set "software=copilot-agent.exe"
...
@echo -a, --address         打印项目对应的 Github 地址
@REM @echo. if this line contains Chinese output, it will be garbled
@echo -h, --help            打印帮助信息
@echo -p, --purge           禁止服务开机自启
@REM @echo. if this line contains Chinese output, it will be garbled
@echo -q, --quit            退出服务
@REM @echo. if this line contains Chinese output, it will be garbled
@echo -r, --restart         重启服务
@echo -s, --start           启动服务
@echo -u, --update          更有可执行程序
echo.
@echo 其他参数：
@REM @echo. if this line contains Chinese output, it will be garbled
@echo -d, --display         前台运行，默认启动守护进程静默执行
@echo -f, --filename        可执行程序文件名
@echo -i, --interactive     新窗口中执行
